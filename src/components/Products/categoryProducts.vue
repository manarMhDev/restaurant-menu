...
const products  = computed(() =>   store.getters.getProductsByCategoryId(category.value.id));
 ...
 <div>
    <div class="row"> 
                      <ul class="breadcrumb">
                         ...
                         <li v-if="store.state.culture === 'ar'">{{category.nameArabic}}</li>
                         <li v-if="store.state.culture === 'en'">{{category.nameEnglish}}</li>
                      </ul> 
                     ...
                     <div class="col-6 col-lg-3 col-sm-6 col-md-4"
                        ...
                        >
                         <router-link :to="{ name: 'details', params: {cat : category.id , id: item.id} }" :title="item.nameEnglish"> 
